...
static rowNamesDim c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                      const emlrtMsgIdentifier *parentId);
...
static varNamesDim e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                      const emlrtMsgIdentifier *parentId);
...
static metaDim emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                const emlrtMsgIdentifier *parentId);
                             ...
                             Continuity y[5])
{
  ...
  emlrtCheckBuiltInR2012b(
      ...
      (void *)&dims[0]);
  for (int32_T i{0}; i < 5; i++) {
    y[i] = static_cast<Continuity>(emlrtGetEnumElementR2009a(u, i));
  }
  emlrtDestroyArray(&u);
}
                         ...
                         const mxArray *plhs[3])
{
  ...
  findMemberType4(&edgesTable, safteyFactor, beamType.data, beamType.size,
...
void findMemberType4_atexit()
{
  ...
  findMemberType4_xil_terminate();
  findMemberType4_xil_shutdown();
